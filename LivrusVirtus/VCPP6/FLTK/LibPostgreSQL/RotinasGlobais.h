...
bool ConsultaDados(CONEXAO pgConLocal, string sSql);
bool ConsultaDadosLista(CONEXAO pgConLocal, LISTAMSTR *lstLocal, string sSql);
bool AtualizaDados(CONEXAO pgConLocal, string sSql);
