...
public:
  ...
  BOOL ConectaBanco(CString sStrConexao);
  VOID DisconectaBanco();
  BOOL ConsultaDados(CONEXAO pConexao, CString sSql);
  BOOL ConsultaDadosLista(CONEXAO pConexao, LISTAMSTR *lstLocal, CString sSql);
  BOOL AtualizaDados(CONEXAO pConexao, CString sSql);
