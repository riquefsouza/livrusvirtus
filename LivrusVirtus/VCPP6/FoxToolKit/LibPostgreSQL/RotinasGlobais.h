...
public:
  ...
  FXbool ConsultaDados(CONEXAO pgConLocal, FXString sSql);
  FXbool AtualizaDados(CONEXAO pgConLocal, FXString sSql);
  FXbool ConsultaDadosLista(CONEXAO pgConLocal, 
