...
public:
  ...
  FXbool ConectaBanco(FXString sStrConexao);
  void DisconectaBanco();
  FXbool ConsultaDados(CONEXAO pConexao, FXString sSql);
  FXbool ConsultaDadosLista(CONEXAO pConexao, LISTAMSTR *lstLocal, 
    FXString sSql);
  FXbool AtualizaDados(CONEXAO pConexao, FXString sSql);
