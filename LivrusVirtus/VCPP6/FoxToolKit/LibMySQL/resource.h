...
extern const unsigned char Cliente[];
extern const unsigned char Livro[];
extern const unsigned char Livros[];
extern const unsigned char Livrus[];
extern const unsigned char LivrusVirtus[];
extern const unsigned char Login[];
extern const unsigned char Sair[];
extern const unsigned char Sobre[];
...
#define STR_NCONPORTA           "Não consigo conectar no servidor mysql na porta atual!"
