...
public:
  ...
  bool ConectaBanco(wxString sStrConexao);
  void DisconectaBanco();
  bool ConsultaDados(CONEXAO pConexao, wxString sSql);
  bool ConsultaDadosLista(CONEXAO pConexao, LISTAMSTR *lstLocal, wxString sSql);
  bool AtualizaDados(CONEXAO pConexao, wxString sSql);
