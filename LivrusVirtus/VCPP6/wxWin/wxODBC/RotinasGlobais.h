...
public:
  ...
  bool AtualizaDados(CONEXAO dbBanco, wxString sSql);
	bool ConsultaDados(CONEXAO dbBanco, wxString sSql);
  bool ConsultaDadosLista(CONEXAO dbBanco, LISTAMSTR *lstLocal, 
    wxString sSql, unsigned long nQtdCol);
