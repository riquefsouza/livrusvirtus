...
GtkWidget *frmCadEnderecos;
GtkWidget *frmCadEnderecos_edtCodigo;
GtkWidget *frmCadEnderecos_edtDescricao;
GtkWidget *frmCadEnderecos_edtBairro;
GtkWidget *frmCadEnderecos_edtCep;
GtkWidget *frmCadEnderecos_edtCidade;
GtkWidget *frmCadEnderecos_cmbEstado;
GtkWidget *frmCadEnderecos_cmbEstadoEntrada;
  ...
  gint nLinhaRegistro, gboolean bInformar)
{
  if (bInformar) {
    ...
    gtk_entry_set_text(GTK_ENTRY(frmCadEnderecos_cmbEstadoEntrada), 
      (const char*)g_list_nth_data(listCmbEstado, 0));
    nRegEnderecos = 0;
  }
...
gint nCont;
 ...
 for (nCont=0; nCont < 26; nCont++) {
    if (strcmp((const char*)g_list_nth_data(listCmbEstado, nCont), sEstado)==0) {
       gtk_entry_set_text(GTK_ENTRY(frmCadEnderecos_cmbEstadoEntrada), 
         (const char*)g_list_nth_data(listCmbEstado, nCont));
       break;
    }
 } 
}
