      ...
      * the limitations of COBOL string handling.
        ...
        01  xStr         PIC X(50) 
          VALUE "   This is the first source string".
        01  xStr2        PIC X(32) 
          VALUE "This is the second source string".
      ...
      *   In this example we get the position of the substring "source".
          ...
          DISPLAY 
           "Task6 First occurrence is in char position " CharCount
      ...
      *   find the position of each in the xString.  Return whichever is the least.
          ...
          END-PERFORM
          DISPLAY 
           "Task7 First occurrence is in char position " EndCount
