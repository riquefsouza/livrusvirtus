/*------------------------------------------------------------------------------
 ...
 Versão programada na linguagem JScript.NET.
------------------------------------------------------------------------------*/
/* programa Livrus */
...
public class Livrus extends System.Object {
  ...
  static var MSG_ARQERRO: String = "Erro: O arquivo não pode ser aberto.";
  static var MSG_ERRO: String = "Erro: opção inválida digite de novo.";
  static var MSG_OPCAO: String = "Escolha uma opção: ";
  static var MSG_PRESS: String = "pressione para continuar...";

  static var MSG_REGINC: String = "registro incluido!";
  static var MSG_REGNINC: String = "registro não incluido!";
  static var MSG_REGALT: String = "registro alterado!";
  static var MSG_REGNALT: String = "registro não alterado!";
  static var MSG_REGEXC: String = "registro excluido!";
  static var MSG_REGNEXC: String = "registro não excluido!";
  static var MSG_REGEXST: String = "registro já existe!";

  static var MSG_NUMINV: String = "Número inválido ou menor do que 1!";
  static var MSG_DATAINV: String = "Data inválida!, formato correto (dd/mm/yyyy)";
  static var MSG_DTHRINV =
                  "Data/hora inválida!, formato correto (dd/mm/yyyy hh:mm:ss)";
  static var MSG_ISBNINV: String = "ISBN inválido!";
  static var MSG_CPFINV: String = "CPF inválido!";
  static var MSG_SENCONFERE: String = "senha não confere com a senha atual!";
  static var MSG_SENCONFIRM="nova senha não confere com a senha confirmada!";
  static var MSG_LOGINENCON: String = "login não encontrado!";
  static var MSG_SEMESTOQUE: String = "livro não existe no estoque!";
