...
namespace Livrus
{
  ...
  if (sTipo=='S') {
   ...
   if (sNome->Equals(S"")==false)
    ...
    sTelefone,S"',",RotinasGlobais::sepDTHR,sDtNascimento,RotinasGlobais::sepDTHR,
    S",",sCodEndereco,S",'",sCodPais,S"',",
    sCodProfissao,S")");
  else if (sTipo=='U')
    ...
    S"',datanasc=",RotinasGlobais::sepDTHR,sDtNascimento,RotinasGlobais::sepDTHR,
    S",codendereco=",sCodEndereco,
  ...
  if ((sTipo=='S') || (sTipo=='P')) {
    ...
    if (sDataVenda->Equals(S"")==false)
  	 sCons=String::Concat(sCons,S" and v.datavenda=",
    ...
    sISBN,S"','",sCPF,S"',",RotinasGlobais::sepDTHR,sDataVenda,RotinasGlobais::sepDTHR,
    S",",sPrecoVenda,S")");
  else if (sTipo=='U')
    ...
    S"' and cpf='",sCPF,S"' and datavenda=",
    RotinasGlobais::sepDTHR,sDataVenda,RotinasGlobais::sepDTHR);
