...
begin
  ...
  {Barra de Menu}
	...
	mnuCadastros.Append(Res.MNU_CAD_ENDERECOS, 'E&ndereços', Res.STR_CADENDERECO);
	mnuCadastros.Append(Res.MNU_CAD_IDIOMAS, '&Idiomas', Res.STR_CADIDIOMA);
	mnuCadastros.Append(Res.MNU_CAD_PAISES, '&Países', Res.STR_CADPAIS);
	mnuCadastros.Append(Res.MNU_CAD_PROFISSOES, 'P&rofissões', Res.STR_CADPROFISS);
	...
	mnuPesquisas.Append(Res.MNU_CON_ENDERECOS, 'E&ndereços', Res.STR_CONENDERECO);
	mnuPesquisas.Append(Res.MNU_CON_IDIOMAS, '&Idiomas', Res.STR_CONIDIOMA);
	mnuPesquisas.Append(Res.MNU_CON_PAISES, '&Países', Res.STR_CONPAIS);
	mnuPesquisas.Append(Res.MNU_CON_PROFISSOES, 'P&rofissões', Res.STR_CONPROFISS);
