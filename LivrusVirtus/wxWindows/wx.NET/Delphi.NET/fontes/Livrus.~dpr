...
{$R 'Principal.resources' 'Principal.resx'}
{%DelphiDotNetAssemblyCompiler '..\produto\wx.NET.dll'}

uses
  System.Reflection,
  System.Runtime.CompilerServices,
  LivrusApp in 'LivrusApp.pas',
  ...
  Sobre in 'Sobre.pas',
  AlterarSenha in 'AlterarSenha.pas',
  ConsultasSQL in 'ConsultasSQL.pas',
  RotinasGlobais in 'RotinasGlobais.pas',
  Cadastros in 'Cadastros.pas',
  CadAssuntos in 'CadAssuntos.pas',
  TextValidatorCtrl in 'TextValidatorCtrl.pas',
  VenderLivros in 'VenderLivros.pas',
  CadClientes in 'CadClientes.pas',
  CadEditoras in 'CadEditoras.pas',
  CadEnderecos in 'CadEnderecos.pas',
  CadIdiomas in 'CadIdiomas.pas',
  CadLivros in 'CadLivros.pas',
  CadPaises in 'CadPaises.pas',
  CadProfissoes in 'CadProfissoes.pas',
  ConAssuntos in 'ConAssuntos.pas',
  ConAutores in 'ConAutores.pas',
  ConClientes in 'ConClientes.pas',
  ConEditoras in 'ConEditoras.pas',
  ConEnderecos in 'ConEnderecos.pas',
  ConIdiomas in 'ConIdiomas.pas',
  ConLivros in 'ConLivros.pas',
  ConPaises in 'ConPaises.pas',
  ConProfissoes in 'ConProfissoes.pas',
  Consultas in 'Consultas.pas',
  ConVendas in 'ConVendas.pas',
  CadAutores in 'CadAutores.pas';
...
var
  aplicativo: TLivrusApp;

[STAThread]
begin
  aplicativo := TLivrusApp.Create();
	aplicativo.Run();
end.
