...
Namespace Livrus
    ...
    private sub OnBtnPesquisar(ByVal sender As Object, ByVal e As wx.Event)
      PesquisarDados(ConsultasSQL.ConsSQL.Autor("S", edtCodigo.Value,""), _
    ...
    private sub OnBtnSalvar(ByVal sender As Object, ByVal e As wx.Event)
      SalvarDados(ValidaDados(true), _
        ConsultasSQL.ConsSQL.Autor("S", edtCodigo.Value,""), _
        ConsultasSQL.ConsSQL.Autor("U", edtCodigo.Value, _
          edtDescricao.Value), _
        ConsultasSQL.ConsSQL.Autor("I", edtCodigo.Value, _
