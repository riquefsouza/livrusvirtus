...
Namespace Livrus
    ...
    private sub OnBtnPesquisar(ByVal sender As Object, ByVal e As wx.Event)
      PesquisarDados(ConsultasSQL.ConsSQL.Assunto("S", edtCodigo.Value,""), _
    ...
    private sub OnBtnSalvar(ByVal sender As Object, ByVal e As wx.Event)
      SalvarDados(ValidaDados(true), _
        ConsultasSQL.ConsSQL.Assunto("S", edtCodigo.Value,""), _
        ConsultasSQL.ConsSQL.Assunto("U", edtCodigo.Value, _
          edtDescricao.Value), _
        ConsultasSQL.ConsSQL.Assunto("I", edtCodigo.Value, _
