...
Namespace Livrus
    ...
    private sub OnBtnPesquisar(ByVal sender As Object, ByVal e As wx.Event)
      PesquisarDados(ConsultasSQL.ConsSQL.Profissao("S", edtCodigo.Value,""), _
    ...
    private sub OnBtnSalvar(ByVal sender As Object, ByVal e As wx.Event)
      SalvarDados(ValidaDados(true), _
        ConsultasSQL.ConsSQL.Profissao("S", edtCodigo.Value,""), _
        ConsultasSQL.ConsSQL.Profissao("U", edtCodigo.Value, _
          edtDescricao.Value), _
        ConsultasSQL.ConsSQL.Profissao("I", edtCodigo.Value, _
