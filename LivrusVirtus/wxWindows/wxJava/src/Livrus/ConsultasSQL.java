...
public class ConsultasSQL {
  ...
  public String Assunto(char sTipo, String sCodigo, String sAssunto) {
    ...
    if (sTipo == 'N') {
      ...
      sCons =
          "select a.codassunto as Código, a.assunto as Assunto from Assunto a" +
  ...
  public String Editora(char sTipo, String sCodigo, String sEditora) {
    ...
    if (sTipo == 'N') {
      ...
      sCons =
          "select e.codeditora as Código, e.editora as Editora from editora e" +
  ...
  public String Usuario(char sTipo, String sLogin, String sSenha) {
    ...
    if (sTipo == 'S') {
      sCons = "select * from Usuario where login='" + sLogin + "' and senha='" +
          sSenha + "'";
    }
    else if (sTipo == 'U') {
      sCons = "update Usuario set senha='" + sSenha + "' where login='" +
          sLogin + "'";
  ...
  public String Livro(char sTipo, String sISBN, String sTitulo, String sEdicao,
                      String sAnoPubli, String sVolume, String sCodEditora,
                      String sCodIdioma,
    ...
    if (sTipo == 'S') {
      ...
      sCons = "insert into Livro(isbn, titulo, edicao, anopubli, codeditora," +
          ...
          sISBN + "','" + sTitulo + "'," + sEdicao + "," + sAnoPubli + "," +
          sCodEditora + "," +
          sVolume + "," + sCodIdioma + "," + sNPaginas + "," + sPreco + "," +
          sQtdEstoque + ")";
    }
    else if (sTipo == 'U') {
      sCons = "update Livro set titulo='" + sTitulo + "',edicao=" + sEdicao +
          ...
          sCodEditora +
          ",codidioma=" + sCodIdioma + ",npaginas=" + sNPaginas + ",preco=" +
          sPreco +
  ...
  public String Cliente(char sTipo, String sCPF, String sNome, String sEmail,
                        String sIdentidade, String sSexo, String sTelefone,
                        String sDtNascimento,
                        String sCodEndereco, String sCodPais,
                        String sCodProfissao) {
    String sCons = "";
    ...
    if (sTipo == 'S') {
      ...
      sCons = "update Cliente set nome='" + sNome + "',email='" + sEmail +
          ...
          sTelefone +
          "',datanasc=" + RotinasGlobais.sepDTHR + sDtNascimento +
          RotinasGlobais.sepDTHR +
  ...
  public String Endereco(char sTipo, String sCodigo, String sLogradouro,
                         String sBairro, String sCEP, String sCidade,
                         String sEstado) {
    String sCons = "";
    ...
    if (sTipo == 'N') {
      ...
      sCons = "update Endereco set logradouro='" + sLogradouro + "',bairro='" +
          sBairro + "',cep='" + sCEP + "',cidade='" + sCidade + "',estado='" +
          sEstado + "'" +
  ...
  public String Venda(char sTipo, String sISBN, String sCPF, String sDataVenda,
    ...
    if ( (sTipo == 'S') || (sTipo == 'P')) {
      ...
      sCons = "update Livro set qtdestoque=" + sQtdEstoque + " where isbn='" +
          sISBN + "'";
    }
    else if (sTipo == 'D') {
