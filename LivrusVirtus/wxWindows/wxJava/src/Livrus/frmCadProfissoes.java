...
public class frmCadProfissoes
  ...
  public frmCadProfissoes(wxWindow parent) {
  ...
  class OnBtnNovoClick
    ...
    public void handleEvent(wxCommandEvent event) {
      btnNovoClick();
      NovoDado(ConsultasSQL.ConsSQL.Profissao('N', edtCodigo.GetValue(), ""));
      event.Skip();
    }
  }
  ...
  class OnBtnSalvarClick
    ...
    public void handleEvent(wxCommandEvent event) {
      SalvarDados(ValidaDados(true),
                  ConsultasSQL.ConsSQL.Profissao('S', edtCodigo.GetValue(), ""),
                  ConsultasSQL.ConsSQL.Profissao('U', edtCodigo.GetValue(),
                                               edtDescricao.GetValue()),
                  ConsultasSQL.ConsSQL.Profissao('I', edtCodigo.GetValue(),
  ...
  class OnBtnExcluirClick
    ...
    public void handleEvent(wxCommandEvent event) {
      ExcluirDados(ValidaDados(false),
                   ConsultasSQL.ConsSQL.Profissao('D', edtCodigo.GetValue(), ""));
      event.Skip();
    }
  }
