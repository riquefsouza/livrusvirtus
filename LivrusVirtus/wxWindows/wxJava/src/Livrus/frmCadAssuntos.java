...
public class frmCadAssuntos
  ...
  public frmCadAssuntos(wxWindow parent) {
  ...
  class OnBtnNovoClick
    ...
    public void handleEvent(wxCommandEvent event) {
      btnNovoClick();
      NovoDado(ConsultasSQL.ConsSQL.Assunto('N', edtCodigo.GetValue(), ""));
      event.Skip();
    }
  }
  ...
  class OnBtnSalvarClick
    ...
    public void handleEvent(wxCommandEvent event) {
      SalvarDados(ValidaDados(true),
                  ConsultasSQL.ConsSQL.Assunto('S', edtCodigo.GetValue(), ""),
                  ConsultasSQL.ConsSQL.Assunto('U', edtCodigo.GetValue(),
                                               edtDescricao.GetValue()),
                  ConsultasSQL.ConsSQL.Assunto('I', edtCodigo.GetValue(),
  ...
  class OnBtnExcluirClick
    ...
    public void handleEvent(wxCommandEvent event) {
      ExcluirDados(ValidaDados(false),
                   ConsultasSQL.ConsSQL.Assunto('D', edtCodigo.GetValue(), ""));
      event.Skip();
    }
  }
