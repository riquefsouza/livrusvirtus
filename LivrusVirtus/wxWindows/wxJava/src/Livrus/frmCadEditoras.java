...
public class frmCadEditoras
  ...
  public frmCadEditoras(wxWindow parent) {
  ...
  class OnBtnNovoClick
    ...
    public void handleEvent(wxCommandEvent event) {
      btnNovoClick();
      NovoDado(ConsultasSQL.ConsSQL.Editora('N', edtCodigo.GetValue(), ""));
      event.Skip();
    }
  }
  ...
  class OnBtnSalvarClick
    ...
    public void handleEvent(wxCommandEvent event) {
      SalvarDados(ValidaDados(true),
                  ConsultasSQL.ConsSQL.Editora('S', edtCodigo.GetValue(), ""),
                  ConsultasSQL.ConsSQL.Editora('U', edtCodigo.GetValue(),
                                               edtDescricao.GetValue()),
                  ConsultasSQL.ConsSQL.Editora('I', edtCodigo.GetValue(),
  ...
  class OnBtnExcluirClick
    ...
    public void handleEvent(wxCommandEvent event) {
      ExcluirDados(ValidaDados(false),
                   ConsultasSQL.ConsSQL.Editora('D', edtCodigo.GetValue(), ""));
      event.Skip();
    }
  }
