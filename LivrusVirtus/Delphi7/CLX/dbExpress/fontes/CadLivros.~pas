...
if bInformar then begin
  edtEdicao.SpecialText:=CDSConsulta.Fields[2].AsString;
  edtAnoPubli.SpecialText:=CDSConsulta.Fields[3].AsString;
  edtVolume.SpecialText:=CDSConsulta.Fields[4].AsString;
  ...
  edtNPaginas.SpecialText:=CDSConsulta.Fields[9].AsString;
  edtPreco.Text:=CDSConsulta.Fields[10].AsString;
  edtQtdEstoque.SpecialText:=CDSConsulta.Fields[11].AsString;
  ...
  edtEdicao.SpecialText:='1';
  edtAnoPubli.SpecialText:=formatdatetime('yyyy',now);
  edtVolume.SpecialText:='1';
  edtCodEditora.Clear;
  edtEditora.Clear;
  edtNPaginas.SpecialText:='1';
  edtPreco.Text:='0,00';
  edtQtdEstoque.SpecialText:='0';
  edtCodAssunto.Clear;
  lstAssuntos.Clear;
  edtCodAutor.Clear;
  lstAutores.Clear;
