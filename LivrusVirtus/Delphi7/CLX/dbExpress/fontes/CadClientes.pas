...
if bInformar then begin
  ...
  edtDtNascimento.Text:=CDSConsulta.Fields[6].AsString;
...
procedure TfrmCadClientes.edtDtNascimentoExit(Sender: TObject);
begin
  inherited;
if edtDtNascimento.Text<>'' then begin
  if Rotinas.ValidaDateTime(edtDtNascimento.Text)=false then begin
