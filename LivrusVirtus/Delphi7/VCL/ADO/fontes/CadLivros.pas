...
uses
  ...
  Cadastros, Db, DBTables, StdCtrls, Spin, ADODB;
...
type
  TfrmCadLivros = class(TfrmCadastros)
    ...
    Label11: TLabel;
    Label12: TLabel;
    edtAnoPubli: TSpinEdit;
    edtEditora: TEdit;
    btnPEditora: TButton;
    edtVolume: TSpinEdit;
    edtNPaginas: TSpinEdit;
    edtQtdEstoque: TSpinEdit;
    edtCodEditora: TEdit;
    edtPreco: TEdit;
    edtCodAssunto: TEdit;
    edtAssunto: TEdit;
...
if bInformar then begin
  edtEdicao.Text:=Consulta.Fields[2].AsString;
  edtAnoPubli.Text:=Consulta.Fields[3].AsString;
  edtVolume.Text:=Consulta.Fields[4].AsString;
  edtCodEditora.Text:=Consulta.Fields[5].AsString;
  edtEditora.Text:=Consulta.Fields[6].AsString;
  cmbIdioma.ItemIndex:=slIdiomas.IndexOf(Consulta.Fields[7].AsString);
  edtNPaginas.Text:=Consulta.Fields[9].AsString;
  edtPreco.Text:=Consulta.Fields[10].AsString;
  edtQtdEstoque.Text:=Consulta.Fields[11].AsString;
