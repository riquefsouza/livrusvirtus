...
static GnomeUIInfo file_menu [] = {
  GNOMEUIINFO_MENU_NEW_ITEM(N_("_New Plivrusgn"),
                            N_("Create a new Plivrusgn"),
                            new_app_cb, NULL),
...
static GnomeUIInfo toolbar [] = {
  GNOMEUIINFO_ITEM_STOCK (N_("New"), N_("Create a new Plivrusgn"), nothing_cb, GNOME_STOCK_PIXMAP_NEW),
...
void 
plivrusgn_install_menus_and_toolbar(GtkWidget* app)
{
...
new_app_cb(GtkWidget* widget, gpointer data)
{
  ...
  app = plivrusgn_app_new(_("Hello, World!"), NULL, NULL);
...
about_cb(GtkWidget* widget, gpointer data)
{
  ...
  if (dialog != NULL) 
    ...
    {        
      const gchar *authors[] = {
        "Henrique F. de Souza <hfs1978@yahoo.com.br>",
        NULL
      };

      gchar* logo = gnome_pixmap_file("plivrusgn-logo.png");

      dialog = gnome_about_new (_("Plivrusgn"), VERSION,
                                "(C) 2005 Henrique F. de Souza",
                                authors,
