...
uses
  ...
  QDialogs, QStdCtrls, QMenus, DBXpress, QExtCtrls, QComCtrls, SqlExpr,
  QImgList, DB;
...
uses Sobre, ConsultasSQL, Login, RotinasGlobais, Splash, AlterarSenha,
  CadAssuntos, CadAutores, ConAssuntos, ConAutores, CadEditoras,
  ConEditoras, CadEnderecos, ConEnderecos, CadIdiomas, ConIdiomas,
  ConPaises, CadPaises, CadProfissoes, ConProfissoes, CadClientes,
  ConClientes, CadLivros, ConLivros, VenderLivros, ConVendas;
