...
{
if (Rotinas->ValidaCampo(edtCodigo->Text.c_bstr(),"ISBN não informado!"))
  return false;
if (bTodosDados) {
  if (Rotinas->ValidaCampo(edtDescricao->Text.c_bstr(),"Título não informado!"))
    return false;
  if (Rotinas->ValidaCampo(edtCodEditora->Text.c_bstr(),"Editora não informada!"))
    return false;
...
if (edtCodEditora->Text!="") {
  ...
  ConsSQL->Editora('S',edtCodEditora->Text.c_bstr(),""),"Editora não encontrada!");
  if (edtEditora->Text=="")
...
if (edtCodAssunto->Text!="") {
  ...
  ConsSQL->Assunto('S',edtCodAssunto->Text.c_bstr(),""),"Assunto não encontrado!");
  if (edtAssunto->Text=="")
...
if (edtCodAutor->Text!="") {
  ...
  ConsSQL->Autor('S',edtCodAutor->Text.c_bstr(),""),"Autor não encontrado!");
  if (edtAutor->Text=="")
