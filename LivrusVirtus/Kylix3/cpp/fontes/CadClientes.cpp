...
{
if (Rotinas->ValidaCampo(edtCodigo->Text.c_bstr(),"CPF não informado!"))
  return false;
if (bTodosDados) {
  if (Rotinas->ValidaCampo(edtDescricao->Text.c_bstr(),"Nome não informado!"))
    return false;
  if (Rotinas->ValidaCampo(edtEmail->Text.c_bstr(),"E-mail não informado!"))
    return false;
  ...
  if (Rotinas->ValidaCampo(edtTelefone->Text.c_bstr(),"Telefone não informado!"))
    return false;
  if (Rotinas->ValidaCampo(edtCodEndereco->Text.c_bstr(),"Endereço não informado!"))
    return false;
  if (Rotinas->ValidaCampo(edtCodPais->Text.c_bstr(),"País não informado!"))
    return false;
  if (Rotinas->ValidaCampo(edtCodProfissao->Text.c_bstr(),"Profissão não informado!"))
    return false;
}
return true;
}
...
if (edtCodPais->Text!="") {
  ...
  ConsSQL->Pais('S',edtCodPais->Text.c_bstr(),""),"País não encontrado!");
  if (edtPais->Text=="")
     edtCodPais->SetFocus();
}
}
...
if (edtCodProfissao->Text!="") {
  ...
  ConsSQL->Profissao('S',edtCodProfissao->Text.c_bstr(),""),"Profissão não encontrada!");
