VERSION 4.00
Begin VB.Form frmCadProfissoes 
   ...
   End
End
Attribute VB_Name = "frmCadProfissoes"
...
Private Sub btnExcluir_Click()
    ...
    ConsSQL.Profissao("D", edtCodigo.Text, "")
End Sub
...
Private Sub btnNovo_Click()
    ...
    fCadastros.NovoDado Me, Consulta, ConsSQL.Profissao("N", edtCodigo.Text, "")
End Sub

Private Sub btnPesquisar_Click()
    fCadastros.PesquisarDados Me, Consulta, _
    ConsSQL.Profissao("S", edtCodigo.Text, ""), "Profissão não encontrada!"
End Sub
...
Private Sub btnSalvar_Click()
    ...
    ConsSQL.Profissao("S", edtCodigo.Text, ""), _
    ConsSQL.Profissao("U", edtCodigo.Text, edtDescricao.Text), _
