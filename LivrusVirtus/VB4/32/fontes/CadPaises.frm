...
Begin VB.Form frmCadPaises 
   ...
   End
End
Attribute VB_Name = "frmCadPaises"
...
Private Sub btnPesquisar_Click()
    ...
    ConsSQL.Pais("S", edtCodigo.Text, ""), "País não encontrado!"
End Sub
...
Private Sub btnSalvar_Click()
    ...
    ConsSQL.Pais("S", edtCodigo.Text, ""), _
    ConsSQL.Pais("U", edtCodigo.Text, edtDescricao.Text), _
