...
Begin VB.Form frmCadIdiomas 
   ...
   End
End
Attribute VB_Name = "frmCadIdiomas"
...
Private Sub btnExcluir_Click()
    ...
    ConsSQL.Idioma("D", edtCodigo.Text, "")
End Sub
...
Private Sub btnNovo_Click()
    ...
    fCadastros.NovoDado Me, Consulta, ConsSQL.Idioma("N", edtCodigo.Text, "")
End Sub

Private Sub btnPesquisar_Click()
    fCadastros.PesquisarDados Me, Consulta, _
    ConsSQL.Idioma("S", edtCodigo.Text, ""), "Idioma não encontrado!"
End Sub
...
Private Sub btnSalvar_Click()
    ...
    ConsSQL.Idioma("S", edtCodigo.Text, ""), _
    ConsSQL.Idioma("U", edtCodigo.Text, edtDescricao.Text), _
