VERSION 4.00
Begin VB.Form frmConProfissoes 
   ...
   Begin MSDBGrid.DBGrid gridConsulta 
      Align           =   1  'Align Top
      Bindings        =   "ConProfissoes.frx":0000
      Height          =   2505
      Left            =   0
      OleObjectBlob   =   "ConProfissoes.frx":0011
      TabIndex        =   8
      Top             =   750
      Width           =   5490
   End
End
Attribute VB_Name = "frmConProfissoes"
...
Private Sub btnLimpar_Click()
    ...
    ConsSQL.Profissao("S", "0", ""), gridConsulta
End Sub

Private Sub btnPesquisar_Click()
    fConsultas.PesquisarDados Me, Consulta, _
    ConsSQL.Profissao("S", "", edtDescricao.Text), _
    "Profissão não encontrado!", gridConsulta
End Sub
