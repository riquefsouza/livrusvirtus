...
public class frmConLivros extends frmConsultas {
  ...
  String[] colNomes={"ISBN", "Título", "Edição", "AnoPublicação", "CodEditora",
    "Volume","Editora", "CodIdioma", "Idioma",
    "NumPáginas", "Preço", "QtdEstoque"};
  ...
  private void jbInit() throws Exception {
    this.setTitle("Consulta de Livros");
  ...
  void this_windowClosing(WindowEvent e) {
    ...
    frmPrincipal.fPrincipal.mnuConLivros.setEnabled(true);
  }
  ...
  void btnPesquisar_actionPerformed(ActionEvent e) {
    PesquisarDados(ConsultasSQL.ConsSQL.Livro('S',"", edtDescricao.getText(),
    "","","","","","","",""),"Livro não encontrado!",colNomes);
  }
