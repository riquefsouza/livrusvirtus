...
public class frmPrincipal extends JFrame {
  ...
  public frmPrincipal() {
    ...
    try  {
      ...
      RotinasGlobais.Rotinas.CentralizaDlg(frmSplash.fSplash);
      frmSplash.fSplash.show();

      frmLogin.fLogin = new frmLogin();
      RotinasGlobais.Rotinas.CentralizaDlg(frmLogin.fLogin);
      frmLogin.fLogin.show();
      statusBar1.setText("Usuário: "+RotinasGlobais.Rotinas.sUsuarioLogin);
    }
    catch (Exception e) {
      e.printStackTrace();
    }
  ...
  private void jbInit() throws Exception  {
    ...
    mnuCadProfissoes.setText("Profissões");
    ...
    mnuConProfissoes.setText("Profissões");
    ...
    mnuCadEnderecos.setText("Endereços");
    ...
    mnuConEnderecos.setText("Endereços");
