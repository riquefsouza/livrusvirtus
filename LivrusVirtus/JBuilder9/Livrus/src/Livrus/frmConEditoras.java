...
public class frmConEditoras extends frmConsultas {
  public static frmConEditoras fConEditoras;
  String[] colNomes={"Código","Editora"};
  ...
  private void jbInit() throws Exception {
    this.setTitle("Consulta de Editoras");
  ...
  void this_windowClosing(WindowEvent e) {
    ...
    frmPrincipal.fPrincipal.mnuConEditoras.setEnabled(true);
  }

  void btnLimpar_actionPerformed(ActionEvent e) {
    LimparDados(ConsultasSQL.ConsSQL.Editora('S',"0",""),colNomes);
  }

  void btnPesquisar_actionPerformed(ActionEvent e) {
    PesquisarDados(ConsultasSQL.ConsSQL.
    Editora('S',"", edtDescricao.getText()),"Editora não encontrada!",colNomes);
  }
