...
public class frmConPaises extends frmConsultas {
  ...
  private void jbInit() throws Exception {
    this.setTitle("Consulta de Países");
  ...
  void this_windowClosing(WindowEvent e) {
    ...
    frmPrincipal.fPrincipal.mnuConPaises.setEnabled(true);
  }

  void btnLimpar_actionPerformed(ActionEvent e) {
    LimparDados(ConsultasSQL.ConsSQL.Pais('S',"0",""),colNomes);
  }

  void btnPesquisar_actionPerformed(ActionEvent e) {
    PesquisarDados(ConsultasSQL.ConsSQL.
    Pais('S',"", edtDescricao.getText()),"País não encontrado!",colNomes);
  }
