...
public class frmCadIdiomas extends frmCadastros {
  ...
  private void jbInit() throws Exception {
    this.setTitle("Cadastro de Idiomas");
  ...
  void btnNovo_actionPerformed(ActionEvent e) {
    ...
    NovoDado(ConsultasSQL.ConsSQL.Idioma('N',edtCodigo.getText(),""));
  }

  void btnExcluir_actionPerformed(ActionEvent e) {
    ExcluirDados(ConsultasSQL.ConsSQL.Idioma('D',edtCodigo.getText(),""));
  }

  void btnPesquisar_actionPerformed(ActionEvent e) {
    PesquisarDados(ConsultasSQL.ConsSQL.Idioma('S',edtCodigo.getText(),""),
    "Idioma não encontrado!",2);
  }

  void btnSalvar_actionPerformed(ActionEvent e) {
    SalvarDados(ConsultasSQL.ConsSQL.Idioma('S',edtCodigo.getText(),""),
    ConsultasSQL.ConsSQL.Idioma('U',edtCodigo.getText(),edtDescricao.getText()),
    ConsultasSQL.ConsSQL.Idioma('I',edtCodigo.getText(),edtDescricao.getText()),
    true);
  }
  ...
  void this_internalFrameClosing(InternalFrameEvent e) {
    ...
    frmPrincipal.fPrincipal.mnuCadIdiomas.setEnabled(true);
  }
