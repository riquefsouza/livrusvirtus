...
public class frmConVendas extends frmConsultas {
  ...
  String[] colNomes={"DataVenda", "CPF", "Cliente", "ISBN","Livro","Preço"};
  ...
  private void jbInit() throws Exception {
    ...
    jPanel5.setMinimumSize(new Dimension(325, 35));
    jPanel5.setPreferredSize(new Dimension(325, 35));
  ...
  void btnPesquisar_actionPerformed(ActionEvent e) {
   try {
    if (PesquisarDados(ConsVenda('S'),"Venda não encontrada!",colNomes)) {
