...
public class frmConProfissoes extends frmConsultas {
  ...
  String[] colNomes={"Código","Profissão"};
  ...
  private void jbInit() throws Exception {
    this.setTitle("Consulta de Profissões");
    labDescricao.setText("Profissão: ");
  ...
  void btnPesquisar_actionPerformed(ActionEvent e) {
    ...
    Profissao('S',"", edtDescricao.getText()),"Profissão não encontrada!",colNomes);
  }
