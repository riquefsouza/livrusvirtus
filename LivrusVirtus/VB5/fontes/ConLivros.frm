...
Begin VB.Form frmConLivros 
   ...
   Begin MSDBGrid.DBGrid gridConsulta 
      Align           =   1  'Align Top
      Bindings        =   "ConLivros.frx":0000
      Height          =   2505
      Left            =   0
      OleObjectBlob   =   "ConLivros.frx":0013
      TabIndex        =   8
      Top             =   750
      Width           =   5490
   End
End
Attribute VB_Name = "frmConLivros"
...
Private Sub btnPesquisar_Click()
    ...
    ConsSQL.Livro("S", "", edtDescricao.Text, _
    "", "", "", "", "", "", "", ""), _
    "Livro não encontrado!", gridConsulta
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    If Consulta.Recordset.RecordCount > 0 Then
       ...
       Rotinas.sPreco = Consulta.Recordset.Fields.Item(2).Value
       Rotinas.sQtdEstoque = Consulta.Recordset.Fields.Item(3).Value
    End If
End Sub
