...
Begin VB.Form frmConIdiomas 
   ...
   Begin MSDBGrid.DBGrid gridConsulta 
      Align           =   1  'Align Top
      Bindings        =   "ConIdiomas.frx":0000
      Height          =   2505
      Left            =   0
      OleObjectBlob   =   "ConIdiomas.frx":0013
      TabIndex        =   8
      Top             =   750
      Width           =   5490
   End
End
Attribute VB_Name = "frmConIdiomas"
...
Private Sub btnLimpar_Click()
    ...
    ConsSQL.Idioma("S", "0", ""), gridConsulta
End Sub

Private Sub btnPesquisar_Click()
    fConsultas.PesquisarDados Me, Consulta, _
    ConsSQL.Idioma("S", "", edtDescricao.Text), _
    "Idioma não encontrado!", gridConsulta
End Sub
