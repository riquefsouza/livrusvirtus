...
Begin VB.Form frmCadEditoras 
   ...
   End
End
Attribute VB_Name = "frmCadEditoras"
...
Private Sub btnExcluir_Click()
    ...
    ConsSQL.Editora("D", edtCodigo.Text, "")
End Sub
...
Private Sub btnNovo_Click()
    ...
    fCadastros.NovoDado Me, Consulta, ConsSQL.Editora("N", edtCodigo.Text, "")
End Sub

Private Sub btnPesquisar_Click()
    fCadastros.PesquisarDados Me, Consulta, _
    ConsSQL.Editora("S", edtCodigo.Text, ""), "Editora não encontrada!"
End Sub
...
Private Sub btnSalvar_Click()
    ...
    ConsSQL.Editora("S", edtCodigo.Text, ""), _
    ConsSQL.Editora("U", edtCodigo.Text, edtDescricao.Text), _
