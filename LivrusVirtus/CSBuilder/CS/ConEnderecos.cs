...
namespace Livrus
{
	...
	/// </summary>
	public class frmConEnderecos : Livrus.frmConsultas
	{
		...
		private void frmConEnderecos_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
		...
		{
			LimparDados(ConsultasSQL.ConsSQL.Endereco('S',"0","","","","",""));
		}

		private void btnPesquisar_Click(object sender, System.EventArgs e)
		{
			PesquisarDados(ConsultasSQL.ConsSQL.Endereco('S',"",
			edtDescricao.Text,"","","",""), "Endereço não encontrado!");
		}

		private void frmConEnderecos_Load(object sender, System.EventArgs e)
		{
