...
//---------------------------------------------------------------------------
Boolean TRotinasGlobais::ConsultaDados(TQuery *Consulta, AnsiString sTextoSql)
{
  Consulta->Close();
...
//---------------------------------------------------------------------------
AnsiString TRotinasGlobais::ConsultaCampoDesc(TQuery *Consulta,
...
//---------------------------------------------------------------------------
void TRotinasGlobais::AdicionaValoresLista(TQuery *ConsLista,
