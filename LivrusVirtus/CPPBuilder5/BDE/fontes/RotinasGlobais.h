...
public:		// User declarations
  ...
  Boolean ConsultaDados(TQuery *Consulta, AnsiString sTextoSql);
  Boolean ValidaCampo(AnsiString sCampo, AnsiString sMensagemErro);
  AnsiString ConsultaCampoDesc(TQuery *Consulta, AnsiString sTextoSql,
             AnsiString sMensagemErro);
  AnsiString ConsultaCampoDesc(TQuery *Consulta, AnsiString sCampoCodigo,
  ...
  void AdicionaValoresLista(TQuery *ConsLista, AnsiString sTextoSql,
