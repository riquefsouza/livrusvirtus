...
begin
  ...
  Self.labAnoPubli.Text := 'Ano Publicação:';
  // 
  // btnPAssunto
  // 
  ...
  Self.labNPaginas.Text := 'Nº Páginas:';
  // 
  // labIdioma
  // 
