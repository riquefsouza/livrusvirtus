...
begin
  ...
  Self.mnuCadEnderecos.Text := 'E&ndereços';
  ...
  Self.mnuConEnderecos.Text := 'E&ndereços';
  ...
  Self.mnuOrganizarIcones.Text := '&Organizar ícones';
  ...
  Self.StatusBarPanel1.Text := 'Usuário:';
