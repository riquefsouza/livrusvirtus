...
begin
  ...
  Self.edtDtNascimento.Format := System.Windows.Forms.DateTimePickerFormat.Short;
  ...
  Self.grpEndereco.Text := 'Endereço';
  // 
  // edtEstado
  // 
  ...
  Self.labPais.Text := 'País de origem:';
  // 
  // btnPPais
  // 
  ...
  Self.labProfissao.Text := 'Profissão:';
  // 
  // frmCadClientes
  // 
...
begin
  ...
  if (bTodosDados) then begin
    ...
    if (rbMasculino.Checked=false) and (rbFeminino.Checked=false) then begin
      MessageBox.Show(Self,'Sexo não informado!',
