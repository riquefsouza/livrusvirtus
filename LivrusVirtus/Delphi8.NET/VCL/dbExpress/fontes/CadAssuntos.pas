...
uses
  ...
  Cadastros, Db, DBTables, StdCtrls, FMTBcd, Borland.Vcl.Provider,
  Borland.Vcl.DBClient, Borland.Vcl.SqlExpr, System.ComponentModel;
...
if bTodosDados then begin
  if Rotinas.ValidaCampo(edtDescricao.Text,'Assunto não informado!') then begin
    result:=false;
    exit;
  end;
end;
