...
#Region " Windows Form Designer generated code "
    ...
    public shared withevents fConEditoras as frmConEditoras
	...
	Me.labDescricao.Text = "Editora:"
        ...
        Me.dataGridTextBoxColumn2.HeaderText = "Editora"
...
#End Region
		...
		private sub frmConEditoras_Closing(sender as object, _
		...
		private sub btnPesquisar_Click(sender as object, _
			...
			Editora("S","", edtDescricao.Text),"Editora não encontrada!")
		end sub

		private sub frmConEditoras_Load(sender as object, _
