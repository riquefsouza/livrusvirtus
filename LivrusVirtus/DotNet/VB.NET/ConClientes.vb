...
#End Region
		...
		private sub frmConClientes_Closing(sender as object, _
		...
		private sub btnLimpar_Click(sender as object, e as System.EventArgs) _
			...
			LimparDados(ConsultasSQL.ConsSQL.Cliente("S","0", _
			"","","","","","","","",""))
		end sub
		...
		private sub btnPesquisar_Click(sender as object, _
			...
			Cliente("S","", edtDescricao.Text, _
			"","","","","","","",""), "Cliente não encontrado!")
		end sub

		private sub frmConClientes_Load(sender as object, _
