...
#End Region
    ...
    private function ValidaDados() as boolean
      if (edtSenhaAtual.Text.Trim() <> _
        ...
        MessageBox.Show("A Senha atual não confere com a senha do usuário!", _
      ...
      if (RotinasGlobais.Rotinas.ValidaCampo(edtNovaSenha.Text, _
            "Nova senha não informada!")) then
        ValidaDados = false
        Exit Function
      end if
      if (edtNovaSenha.Text.Trim() <> edtConfirmarSenha.Text.Trim()) then
        MessageBox.Show("A Nova senha não confere com a senha a confirmar!", _
        frmPrincipal.fPrincipal.Text, MessageBoxButtons.OK, _
        MessageBoxIcon.Error)
        ValidaDados = false
        Exit Function
