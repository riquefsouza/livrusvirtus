...
#Region " Windows Form Designer generated code "
	...
	Me.labDescricao.Text = "Logradouro:"
        ...
        Me.dataGridTextBoxColumn2.HeaderText = "Endereco"
        ...
        Me.Name = "frmConEnderecos"
        Me.Text = "Consulta de Enderecos"
...
#End Region
		...
		private sub frmConEnderecos_Closing(sender as object, _
		...
		private sub btnPesquisar_Click(sender as object, _
			...
			Endereco("S","", edtDescricao.Text,"","","",""), _
			"Endereço não encontrado!")
		end sub

		private sub frmConEnderecos_Load(sender as object, _
