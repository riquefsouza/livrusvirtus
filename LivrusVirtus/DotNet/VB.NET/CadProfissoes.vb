...
#Region " Windows Form Designer generated code "
    ...
    public shared withevents fCadProfissoes as frmCadProfissoes
	...
	Me.labDescricao.Text = "Profissão:"
        '
        ' edtDescricao
        '
        ...
        Me.Name = "frmCadProfissoes"
        Me.Text = "Cadastro de Profissões"
    End Sub
...
#End Region
    ...
    private sub btnPesquisar_Click(sender as object, e as System.EventArgs) _
        ...
        PesquisarDados(ConsultasSQL.ConsSQL.Profissao("S",edtCodigo.Text,""), _
    ...
    private sub btnSalvar_Click(sender as object, e as System.EventArgs) _
        ...
        SalvarDados(ConsultasSQL.ConsSQL.Profissao("S",edtCodigo.Text,""), _
        ConsultasSQL.ConsSQL.Profissao("U",edtCodigo.Text,edtDescricao.Text), _
        ConsultasSQL.ConsSQL.Profissao("I",edtCodigo.Text,edtDescricao.Text), _
        true)
    end sub

    private sub frmCadProfissoes_Closing(sender as object, _
