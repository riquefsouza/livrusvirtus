...
#Region " Windows Form Designer generated code "
	...
	Me.labDescricao.Text = "Livro:"
        ...
        Me.dataGridTextBoxColumn2.HeaderText = "Livro"
        ...
        Me.Name = "frmConLivros"
        Me.Text = "Consulta de Livros"
...
#End Region
		...
		private sub frmConLivros_Closing(sender as object, _
		...
		private sub btnLimpar_Click(sender as object, e as System.EventArgs) _
			...
			LimparDados(ConsultasSQL.ConsSQL.Livro("S","0", _
			"","","","","","","","",""))
		end sub
		...
		private sub btnPesquisar_Click(sender as object, _
			...
			Livro("S","", edtDescricao.Text, _
			"","","","","","","",""),"Livro não encontrado!")
		end sub

		private sub frmConLivros_Load(sender as object, _
