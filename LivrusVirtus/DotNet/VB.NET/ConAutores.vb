...
#Region " Windows Form Designer generated code "
	...
	Me.labDescricao.Text = "Autor:"
        ...
        Me.dataGridTextBoxColumn2.HeaderText = "Autor"
        ...
        Me.Name = "frmConAutores"
        Me.Text = "Consulta de Autores"
...
#End Region
		...
		private sub frmConAutores_Closing(sender as object, _
		...
		private sub btnPesquisar_Click(sender as object, _
			...
			Autor("S","", edtDescricao.Text), "Autor não encontrado!")
		end sub

		private sub frmConAutores_Load(sender as object, _
