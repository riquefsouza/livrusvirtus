...
#Region " Windows Form Designer generated code "
	...
	Me.labAnoPubli.Text = "Ano Publicação:"
	' 
	' btnPAssunto
	' 
	...
	Me.labNPaginas.Text = "Nº Páginas:"
	' 
	' labIdioma
	' 
    ...
    protected overrides function ValidaDados(bTodosDados as boolean) as boolean
        ...
        if (bTodosDados) then
          ...
          if (lstAutores.Items.Count = 0) then
            MessageBox.Show(Me,"Autor(es) não informado(s)!", _
            frmPrincipal.fPrincipal.Text, MessageBoxButtons.OK, _
            MessageBoxIcon.Error)
            ValidaDados = false
            exit function
