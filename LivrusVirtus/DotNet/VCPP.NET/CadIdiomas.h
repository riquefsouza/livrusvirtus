...
namespace Livrus
{
  public __gc class frmCadIdiomas : public Livrus::frmCadastros
  {
  public:
	static frmCadIdiomas* fCadIdiomas;
	frmCadIdiomas();
  private: 
	System::ComponentModel::IContainer* components;
  	...
  	Void frmCadIdiomas_Closing(Object* sender, System::ComponentModel::CancelEventArgs* e);
  protected: 
