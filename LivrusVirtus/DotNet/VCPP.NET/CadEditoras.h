...
namespace Livrus
{
  public __gc class frmCadEditoras : public Livrus::frmCadastros
  {
  public:
	static frmCadEditoras* fCadEditoras;
	frmCadEditoras();
  private: 
	System::ComponentModel::IContainer* components;
  	...
  	Void frmCadEditoras_Closing(Object* sender, System::ComponentModel::CancelEventArgs* e);
  protected: 
