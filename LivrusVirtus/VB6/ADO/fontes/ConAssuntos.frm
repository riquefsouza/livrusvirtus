...
Begin VB.Form frmConAssuntos 
   ...
   End
End
Attribute VB_Name = "frmConAssuntos"
...
Private Sub btnLimpar_Click()
    fConsultas.LimparDados Me, Consulta, ConsSQL.Assunto("S", "0", ""), gridConsulta
End Sub

Private Sub btnPesquisar_Click()
    fConsultas.PesquisarDados Me, Consulta, _
    ConsSQL.Assunto("S", "", edtDescricao.Text), _
    "Assunto não encontrado!", gridConsulta
End Sub
