...
Begin VB.Form frmCadLivros 
   ...
   Begin VB.ListBox lstAutores 
      Height          =   645
      ItemData        =   "CadLivros.frx":0000
      Left            =   1440
      List            =   "CadLivros.frx":0002
      TabIndex        =   34
      Top             =   4440
      Width           =   4935
   End
   Begin VB.ListBox lstAssuntos 
      Height          =   645
      ItemData        =   "CadLivros.frx":0004
      Left            =   1440
      List            =   "CadLivros.frx":0006
      TabIndex        =   26
      Top             =   3120
      Width           =   4935
   End
   Begin VB.ComboBox cmbIdioma 
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "CadLivros.frx":0008
      Left            =   1440
      List            =   "CadLivros.frx":000A
...
Private ConsLista As Recordset
