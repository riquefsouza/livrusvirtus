...
Begin VB.Form frmConEditoras 
   ...
   Begin MSDBGrid.DBGrid gridConsulta 
      Align           =   1  'Align Top
      Bindings        =   "ConEditoras.frx":0000
      Height          =   2505
      Left            =   0
      OleObjectBlob   =   "ConEditoras.frx":0013
      TabIndex        =   8
      Top             =   750
      Width           =   5490
   End
End
Attribute VB_Name = "frmConEditoras"
...
Private Sub btnLimpar_Click()
    ...
    ConsSQL.Editora("S", "0", ""), gridConsulta
End Sub

Private Sub btnPesquisar_Click()
    fConsultas.PesquisarDados Me, Consulta, _
    ConsSQL.Editora("S", "", edtDescricao.Text), _
    "Editora não encontrada!", gridConsulta
End Sub
