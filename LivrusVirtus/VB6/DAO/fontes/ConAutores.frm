...
Begin VB.Form frmConAutores 
   ...
   Begin MSDBGrid.DBGrid gridConsulta 
      Align           =   1  'Align Top
      Bindings        =   "ConAutores.frx":0000
      Height          =   2505
      Left            =   0
      OleObjectBlob   =   "ConAutores.frx":0013
      TabIndex        =   8
      Top             =   750
      Width           =   5490
   End
End
Attribute VB_Name = "frmConAutores"
...
Private Sub btnLimpar_Click()
    ...
    ConsSQL.Autor("S", "0", ""), gridConsulta
End Sub

Private Sub btnPesquisar_Click()
    fConsultas.PesquisarDados Me, Consulta, _
    ConsSQL.Autor("S", "", edtDescricao.Text), _
    "Autor não encontrado!", gridConsulta
End Sub
