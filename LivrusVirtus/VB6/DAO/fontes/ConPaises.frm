...
Begin VB.Form frmConPaises 
   ...
   Begin MSDBGrid.DBGrid gridConsulta 
      Align           =   1  'Align Top
      Bindings        =   "ConPaises.frx":0000
      Height          =   2505
      Left            =   0
      OleObjectBlob   =   "ConPaises.frx":0013
      TabIndex        =   8
      Top             =   750
      Width           =   5490
   End
End
Attribute VB_Name = "frmConPaises"
...
Private Sub btnLimpar_Click()
    ...
    ConsSQL.Pais("S", "0", ""), gridConsulta
End Sub

Private Sub btnPesquisar_Click()
    fConsultas.PesquisarDados Me, Consulta, _
    ConsSQL.Pais("S", "", edtDescricao.Text), _
    "País não encontrado!", gridConsulta
End Sub
