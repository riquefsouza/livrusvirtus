...
if (bInformar) {
  edtEdicao->Text=Consulta->Fields->Fields[2]->AsString;
  edtAnoPubli->Text=Consulta->Fields->Fields[3]->AsString;
  edtVolume->Text=Consulta->Fields->Fields[4]->AsString;
  edtCodEditora->Text=Consulta->Fields->Fields[5]->AsString;
  edtEditora->Text=Consulta->Fields->Fields[6]->AsString;
  cmbIdioma->ItemIndex=slIdiomas->IndexOf(Consulta->Fields->Fields[7]->AsString);
  edtNPaginas->Text=Consulta->Fields->Fields[9]->AsString;
  edtPreco->Text=Consulta->Fields->Fields[10]->AsString;
  edtQtdEstoque->Text=Consulta->Fields->Fields[11]->AsString;
